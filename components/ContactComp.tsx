...
export const ContactComp = ({ onSubmitHandler , isLoading}: ContactCompProps) => {
    return <>
                ...
                <ul className="mt-4 flex flex-wrap justify-center gap-6">
                    <li className="flex items-center text-blue-600">
                        ...
                        <div className="text-sm ml-4">
                            <strong>timetotravelconsultants@gmail.com</strong>
                        </div>
                    </li>
                    <li className="flex items-center text-blue-600">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16px" height="16px" fill='currentColor'
                        ...
                        <div className="flex flex-col text-sm ml-4">
                            <strong>+91 99157-91463</strong>
                            <strong>+91 73476 66159</strong>
                        </div>
                    </li>
                </ul>
            </div>
            <div className="z-10 relative h-full max-md:min-h-[350px]">
                <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3429.869543033395!2d76.76791659999999!3d30.7220677!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x390fed88a6cb9b31%3A0xa93b85b6c9edd897!2sBlinkit%20Center%2034A!5e0!3m2!1sen!2sin!4v1729539813372!5m2!1sen!2sin"
