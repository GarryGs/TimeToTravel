...
const features = [
  {
    name: '8+ Year Experience',
    description:
      'Serving our clients from 8+ years to get Tourists/Study/Work permit visas in countries like Canada, Australia, UK, New Zealand and Europe. ',
    icon: CapIcon,
  },
  {
    name: 'Expert Staff',
  ...
  },
  {
    ...
    description: "At Time To Travel, we don't only believe in applying for visas but also consulting our customers in choosing a right path for their career",
    icon: TickIcon,
  },
]
                ...
                {features.map((feature) => (
                  <div key={feature.name} className="relative pl-9">
                    <dt className="inline font-semibold text-gray-900">
                      ...
                      <span className="absolute left-1 top-1 h-5 w-5 text-indigo-600">
