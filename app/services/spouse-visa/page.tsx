...
const SpouseProps = {
    imageUrl: "https://w5lyingog1fowzo0.public.blob.vercel-storage.com/spouse-visa/spouse-visa2-p0qgZcbXIIkYC8OhbPShkv4IdwJOCo.jpg",
    title: "Spouse Visa",
};
    ...
    return (
        <>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:mx-32 xl:mx-60 my-16">
                ...
                <img className="object-cover w-full h-auto rounded-xl" src="https://w5lyingog1fowzo0.public.blob.vercel-storage.com/spouse-visa/spouse-canada-LIgWDkorJRmuP3QMTNHoAcHaDVVYMv.webp" alt="Canada Spouse Visa" />
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:mx-32 xl:mx-60 my-16">
                <img className="object-cover w-full h-auto rounded-xl" src="https://w5lyingog1fowzo0.public.blob.vercel-storage.com/spouse-visa/spouse-open-work-permit-O0XuDUsFdgf2hovxjLWqFXW8pQEkxV.avif" alt="Canada Spouse Visa - Homecoming Illustration" />
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:mx-32 xl:mx-60 my-16">
                ...
                <img className="object-cover w-full h-auto rounded-xl" src="https://w5lyingog1fowzo0.public.blob.vercel-storage.com/spouse-visa/spouse-uk-klTcY30ypuAMOaXUVZHJjTPWEuGjUf.png" alt="UK Spouse Visa" />
            </div>
        </>
    );
}
